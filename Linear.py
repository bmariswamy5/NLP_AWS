...
# Model
model = DistilBertForSequenceClassification.from_pretrained('distilbert-base-uncased', num_labels=len(label_columns))
...
submission_df.to_csv('/home/ubuntu/NLP_AWS/Test_submission_netid1.csv', index=False)
